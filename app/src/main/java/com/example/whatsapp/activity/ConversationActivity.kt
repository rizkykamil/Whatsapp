...
import com.example.whatsapp.adapter.ConversationAdapter
...
class ConversationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        populateImage(this, imageUrl, img_toolbar_conversation, R.drawable.ic_user)
        txt_toolbarconversation.text = chatName
